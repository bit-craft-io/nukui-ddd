...
final class StfStaDevelopTool
{
     ...
     *
     * @param mixed $value
     * @param Enums\TypeSizeUnit $type_size_unit
     * @param int $depth
     * @return float|null
     */
    public static function getValueSize(mixed $value, Enums\TypeSizeUnit $type_size_unit = Enums\TypeSizeUnit::Kb, int $depth = 3): float|null
    {
